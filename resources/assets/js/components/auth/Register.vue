        ...
        <div class="registration-form">
            ...
            <form method="POST" action="/register" id="frm-register" @submit.prevent="submitRegister">
                ...
                <div class="form-group required">
                    <input class="form-control" placeholder="First name" name="first_name" type="text" v-model="firstName">
                </div>
                <div class="form-group required">
                    <input class="form-control" placeholder="Last name" name="last_name" type="text" v-model="lastName">
                </div>
                ...
                <div class="form-group has-feedback required">
                    <input class="form-control" placeholder="Confirm password" name="password_confirmation" v-model="passwordConfirmation" type="password">
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>
                <div class="form-group">
                    <input class="form-control" placeholder="Coupon code" name="coupon_code" type="text" v-model="couponCode">
                </div>
                <div class="row">
                    <div class="col-sm-7">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="y" name="agree_terms" id="chk-agree-terms" v-model="agreeTerms">
                                &nbsp; I agree to the <a href="#">terms</a>
                            </label>
                        </div>
                    </div>
                    <div class="col-sm-5">
                        <input class="btn btn-primary btn-block btn-flat" type="submit" :disabled="isRegistering" :value="isRegistering ? 'SIGNING UP' : 'SIGN UP NOW'">
                    </div>
                </div>
            </form>
