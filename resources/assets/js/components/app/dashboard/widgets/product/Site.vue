...
<script>
    ...
    export default{
        ...
        mounted(){
            console.info('Site component mounted.');
            this.initSetParams();
            this.loadChartData();
        },
        watch: {
        ...
        data(){
            return {
                ...
                deleteParams: {
                    title: 'Chart',
                    list: [
                        'All URL data associated with this Chart displayed on the Dashboard',
                    ],
                    active: false,
                },
        ...
        methods: {
            ...
            loadChartData(){
                this.isLoading = true;
                axios.get('/chart/site', this.loadChartDataRequestData).then(response => {
