    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body p-20">
                <div class="row m-b-15">
                    <div class="col-sm-6">
                        ...
                        <select class="form-control sl-form-control input-sm" v-model="paginationData.per_page"
                                @change="loadDomains(currentPageUrl)">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <a href="/url-management/domain/create" class="btn btn-primary btn-sm btn-flat">CREATE NEW
                            DOMAIN</a>
                    </div>
                    <div class="col-sm-6 text-right">
...
<script>
    import singleDomainRow from './SingleDomainRow.vue';
    ...
    export default {
        ...
        methods: {
            loadDomains(link){
                ...
                axios.get(link).then(response => {
                    if (response.data.status == true) {
                        ...
                        this.paginationData.current_page = response.data.domains.current_page;
                        this.paginationData.from = response.data.domains.from;
                        this.paginationData.last_page = response.data.domains.last_page;
                        this.paginationData.next_page_url = response.data.domains.next_page_url;
                        this.paginationData.per_page = response.data.domains.per_page;
                        this.paginationData.prev_page_url = response.data.domains.prev_page_url;
                        this.paginationData.to = response.data.domains.to;
                        this.paginationData.total = response.data.domains.total;
                    }
                }).catch(error => {
            ...
            setOrdering(column){
                ...
                this.loadDomains(this.currentPageUrl);
            },
            onFilterChanged(){
