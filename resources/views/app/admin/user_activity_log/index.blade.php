...
@section('title', 'User Activity Logs - SpotLite')
        ...
        <default-template v-cloak>
            ...
            <default-content slot="default-content">
                <content-header slot="content-header">
                    <span slot="content-header-title">User Activity Logs</span>
                </content-header>
...
@section('scripts')
    <script src="{{mix('/js/app/admin/user_activity_log/index.js')}}"></script>
@stop