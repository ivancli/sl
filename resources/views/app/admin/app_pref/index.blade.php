...
@section('title', 'Application Preferences - SpotLite')
        ...
        <default-template v-cloak>
            ...
            <default-content slot="default-content">
                <content-header slot="content-header">
                    <span slot="content-header-title">Application Preferences</span>
                </content-header>
...
@section('scripts')
    <script src="{{mix('/js/app/admin/app_pref/index.js')}}"></script>
@stop