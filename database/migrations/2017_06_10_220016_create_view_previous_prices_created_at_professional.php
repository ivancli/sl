...
class CreateViewPreviousPricesCreatedAtProfessional extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement('
            CREATE VIEW previous_prices_created_at_professional AS 
            (
                select
                ...
                from
                    historical_prices
                join 
                    recent_prices_professional recent_historical_prices
                on
                (
    ...
    {
        DB::statement('
            DROP VIEW previous_prices_created_at_professional
        ');
    }
}
