...
class CreateViewRecentPricesCreatedAtBusiness extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement('
            CREATE VIEW recent_prices_created_at_business
            AS (
    ...
    {
        DB::statement('DROP VIEW recent_prices_created_at_business');
    }
}
