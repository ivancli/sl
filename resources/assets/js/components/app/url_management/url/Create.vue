<template>
    ...
    <section class="content">
                ...
                <form class="form-horizontal" onsubmit="return false;">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 text-right">
                            <button class="btn btn-primary btn-sm btn-flat" @click.prevent="createUrl">SAVE</button>
        ...
        <loading v-if="isCreatingUrl"></loading>
    </section>
</template>
    ...
    export default{
        ...
        methods: {
            createUrl(){
                ...
                axios.post('/url-management/url', this.createUrlData).then(response => {
