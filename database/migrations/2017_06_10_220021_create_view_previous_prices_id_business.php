...
class CreateViewPreviousPricesIdBusiness extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement('
            CREATE VIEW previous_prices_id_business AS 
            (
                select 
                ...
                from 
                    `historical_prices` 
                    join `recent_prices_business` `recent_historical_prices` 
                    on
                    (
    ...
    {
        DB::statement('
            DROP VIEW previous_prices_id_business
        ');
    }
}
