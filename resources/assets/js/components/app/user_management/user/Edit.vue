<template>
    ...
    <section class="content">
            ...
            <div class="box-body p-20">
                ...
                <form class="form-horizontal" onsubmit="return false;">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="txt-email" v-model="email" disabled="disabled">
                        </div>
                    </div>
        ...
        <loading v-if="isEditingUser || isLoadingUser"></loading>
    </section>
</template>
    ...
    export default{
        ...
        methods: {
            loadUser(){
                ...
                axios.get(editingUser.urls.show).then(response=> {
            ...
            editUser(){
                ...
                axios.put(editingUser.urls.update, this.editUserData).then(response=> {
