<template>
    ...
    <section class="content">
                ...
                <form class="form-horizontal" onsubmit="return false;">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 text-right">
                            <button class="btn btn-primary btn-sm btn-flat" @click.prevent="createRole">CREATE</button>
        ...
        <loading v-if="isCreatingRole || isLoadingPermissions"></loading>
    </section>
</template>
    ...
    export default{
        ...
        methods: {
            createRole(){
                ...
                axios.post('/user-management/role', this.createRoleData).then(response=> {
